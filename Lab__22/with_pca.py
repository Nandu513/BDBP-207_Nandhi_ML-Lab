...
def split_data(df_path):
    ...
    return train_test_split(x_scaled, y_encoded, test_size=0.3, random_state=1)
...
def logistic_pipeline(x_train, x_test, y_train, y_test):
    ...
    # Hyperparameter tuning for both PCA and Logistic Regression
    param_grid = {
    ...
    print("\n[Linear reg] Best Parameters Found:")
    print(grid.best_params_)
