...
def adaboost_regressor(x_train, x_test, y_train, y_test):
    base_tree = DecisionTreeRegressor(random_state=42)  # Base estimator
    ...
    grid = GridSearchCV(ada, param_grid, cv=5, scoring='r2', n_jobs=-1)
    ...
    # Save model
    joblib.dump(best_model, "adaboost_regressor.pkl")
    print("\nModel saved as 'adaboost_regressor.pkl'")
